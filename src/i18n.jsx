    ...
    resources: {
      en: {
        translation: {
          ...
          im: "I'm",
          short_intro:
            `As a software engineer with ${moment('2022-05').locale('en').fromNow(true)} experience, I focus on creating user-friendly solutions for complex challenges. I'm passionate about coding and staying updated on new tech trends. My goal is to deliver top-notch software that exceeds expectations, whether I'm working solo or with a team. I thrive in innovative environments, always looking to enhance my skills.`,
          short_contact:
